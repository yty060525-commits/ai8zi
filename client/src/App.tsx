...
import { BUILD_ID, versionLabel } from './utils/buildInfo';
...
export function App() {
  ...
  </div><p className="build-stamp" title={'构建号 ' + BUILD_ID} aria-label="页面版本">{versionLabel()}</p><BottomNav active={section} onChange={(nextSection) => { setSettingsOpen(false); handleSectionChange(nextSection); }} /></div>;
}
