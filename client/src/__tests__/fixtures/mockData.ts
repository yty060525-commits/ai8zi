...
const sampleNonAiResult: NonAiChart = {
  ...
  hiddenStems: [['癸'], ['甲', '丙', '戊'], ['丁', '己'], ['丁', '己']], tenGods: ['正财', '偏财', '日主', '食神'], naYin: ['海中金', '炉中火', '路旁土', '杨柳木'], dayMaster: '庚', forecastRange: [2025, 2026],
